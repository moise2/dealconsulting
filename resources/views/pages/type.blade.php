...
<section class="content-header">
  <div class="content-header">
    <div class="container">
      <div class="row mb-2">
        <div class="col-sm-6">
          <a class="btn btn-app bg-success" style="margin: 1%"role="menuitem" href="#" data-toggle="modal" data-target="#addtype">
            <span class="badge bg-purple">{{$types->count()}}</span>
            <i class="fas fa-users"></i> Types
        </a>
                          ...
                          <div class="form-row">
                              <div class="form-group col-md-12">
                                <div class="form-group">
                                   <label>Adresse:</label>
                                  <div class="input-group">
                                    <textarea required   class="form-control" id="Adresse" cols="30" rows="4" inputmode="text" name="Description"></textarea>
                                  </div>
                                  <!-- /.input group -->
                              </div>
                              </div>
                  ...
                  <tr>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="#" data-toggle="modal" data-target="#Typemodif{{$pe->id}}" class="btn btn-info"><i class="fas fa-eye"></i></a>
                        <a href="#" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  <div class="modal fade" id="Typemodif{{$pe->id}}" role="dialog">
                    <div class="modal-dialog modal-lg" >
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: rgb(43, 43, 44)">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <form action="{{route('type.update',$pe->id)}}" method="post" enctype="multipart/form-data">
                              <div class="modal-body">
                                      {{ csrf_field() }}
                                      @method('PUT')
