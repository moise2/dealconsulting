CREATE TABLE IF NOT EXISTS `pays` (
	...
	`fipsCode` char() DEFAULT NULL,
	`isoNumeric` char() DEFAULT NULL,
	`north` varchar() DEFAULT NULL,
	`south` varchar() DEFAULT NULL,
	`east` varchar() DEFAULT NULL,
	`west` varchar() DEFAULT NULL,
	`capital` varchar() DEFAULT NULL,
	`continentName` varchar() DEFAULT NULL,
...
INSERT INTO `pays` (`countryCode`, `countryName`, `currencyCode`, `fipsCode`, `isoNumeric`, `north`, `south`, `east`, `west`, `capital`, `continentName`, `continent`, `languages`, `isoAlpha3`, `geonameId`) VALUES
